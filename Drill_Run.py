...
with open('/nfs/eor-00/h1/mwilensk/RFI_Diagnostic_Diffuse_2015/Broadband_OBSIDS_paths.txt') as g:
...
outpaths = glob.glob('/nfs/eor-00/h1/mwilensk/Drill_Plots_Golden_Set/' +
                     str(obslist[args.id - 1]) + '_Drill_All_*.png')
...
if not outpaths:
    ...
    RFI.catalog_drill(obslist[args.id - 1], pathlist[args.id - 1],
                      '/nfs/eor-00/h1/mwilensk/RFI_Diagnostic_Diffuse_2015/', 'ant-freq')
else:
