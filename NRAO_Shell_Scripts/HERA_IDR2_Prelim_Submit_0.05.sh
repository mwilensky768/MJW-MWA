...
do
  ...
  do
    ...
    echo $obsid
    outdir=/lustre/aoc/projects/hera/mwilensk/HERA_IDR2_Prelim_Set_0.05
    for pol in xx yy xy yx
    do
      obs=${obsid}.${pol}.HH
      echo $obs
      indir=/lustre/aoc/projects/hera/H1C_IDR2/${day}/${obs}.uv
      python /lustre/aoc/projects/hera/mwilensk/MJW-MWA/Catalog_Gen.py $obs $indir $outdir 0.05
    done
  done
done
