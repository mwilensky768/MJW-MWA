...
GLEAM_filelist.append('%s/metadata/%s_nsamplemax_RFI_plus_gleam_half_flux_same_pos_settings.txt' % (args.GLEAM_filepath, args.obsid))
GLEAM_filelist.append('%s/metadata/%s_nsamplemax_RFI_plus_gleam_half_flux_same_pos_params.sav' % (args.GLEAM_filepath, args.obsid))
