...
#  bash $wrapper -f ${2014_SSINS_dir}/2014_EoR_High_Pointing_${pointing}_obs.txt -o ${2014_SSINS_dir}/2014_${pointing}_outputs -s $script -m 50G -t 02:00:00 -a 2 -b 80 -e 80 -i 2 -c 2
#  sleep 2h
#done
