...
obslist_path = '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Long_Run_8s_Autos_OBSIDS.txt'
pathlist_path = '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Long_Run_8s_Autos_OBSIDS_paths.txt'
outpath = {'waterfall': '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Freq_Time/',
           'vis_avg': '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Vis_Avg/Unflagged/',
           'flag': '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Flags/'}
...
writepath = '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Freq_Time/Variances/'
bins = 'auto'
...
amp_avg = 'Amp'
vis_avg_write = True
vis_avg_writepath = '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Vis_Avg/Unflagged/Averages/'
invalid_mask = True
...
output = '%s%s*.png' % ('/nfs/eor-00/h1/mwilensk/Grand_Catalog/Vis_Avg/Unflagged/', str(obs))
