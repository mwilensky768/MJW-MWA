...
outpath = {'waterfall': '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Freq_Time/',
           'vis_avg': '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Vis_Avg/',
...
amp_avg = 'Amp'
vis_avg_write = True
vis_avg_writepath = '/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Vis_Avg/Averages/'
...
output = '%s%s*.png' % ('/nfs/eor-00/h1/mwilensk/Grand_Catalog/Long_Run_8s_Autos/Flags/', str(obs))
